...
import com.decentralchain.lang.v1.EnvironmentFunctionsBenchmark._
...
import com.decentralchain.lang.v1.evaluator.ctx.impl.unitoken.{Functions, unitokenContext}
...
class AddressFromString {
  val ctx: EvaluationContext[Environment, Id] =
    unitokenContext.build(DirectiveSet(V4, Account, DApp).explicitGet())
