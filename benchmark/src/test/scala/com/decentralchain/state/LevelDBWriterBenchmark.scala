...
import com.decentralchain.database.{DBExt, Keys, LevelDBFactory, LevelDBWriter}
import com.decentralchain.settings.{unitokenSettings, loadConfig}
import com.decentralchain.state.LevelDBWriterBenchmark._
...
object LevelDBWriterBenchmark {
  ...
  class BaseSt {
    ...
    val db = LevelDBWriter.readOnly(rawDB, unitokenSettings)
