...
package object api {
  ...
  implicit val distributionReads: Reads[AssetDistribution] = Reads { json =>
    json
      .validate[Map[com.decentralchain.account.Address, Long]]
  ...
  implicit val distributionPageReads: Reads[AssetDistributionPage] = Reads { json =>
    json.validate[Paged[com.decentralchain.account.Address, AssetDistribution]].map(pg => AssetDistributionPage(pg))
  }
}
