...
import com.decentralchain.it.{ExternalNode, GrpcIntegrationSuiteWithThreeAddress, GrpcWaitForHeight, Node, NodeConfigs}
...
trait GrpcBaseTransactionSuiteLike
  ...
  protected lazy val theNodes: Coeval[Seq[Node]] = Coeval.evalOnce {
    Option(System.getProperty("unitoken.it.config.file")) match {
