...
import com.decentralchain.transaction.{CreateAliasTransaction, DataTransaction, Proofs, Transaction, TxVersion}
  ...
  lazy val mass = MassTransferTransaction
    .create(
      ...
      MassTransferTransaction
        .parseTransfersList(List(Transfer(firstKeyPair.toAddress.toString, 1.unitoken), Transfer(secondKeyPair.toAddress.toString, 2.unitoken)))
        .explicitGet(),
      2.unitoken,
      ts,
