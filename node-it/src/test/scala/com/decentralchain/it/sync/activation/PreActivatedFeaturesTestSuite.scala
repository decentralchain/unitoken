...
import com.decentralchain.it.{Docker, ReportingTestName}
...
object PreActivatedFeaturesTestSuite {
  ...
  private val supportedConfig    = ConfigFactory.parseString(s"""unitoken {
                                                             ...
                                                             |  miner.quorum = 1
                                                             |}""".stripMargin)
  private val preactivatedConfig = ConfigFactory.parseString(s"""unitoken {
                                                                |  blockchain.custom.functionality {
                                                                |  feature-check-blocks-period = $votingInterval
                                                                |  pre-activated-features {
                                                                |        1 = 0
