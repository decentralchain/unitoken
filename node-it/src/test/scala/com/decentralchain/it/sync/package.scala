...
import com.decentralchain.protobuf.transaction.{DataTransactionData, PBTransactions}
import com.decentralchain.state.DataEntry
import com.decentralchain.transaction.assets.IssueTransaction
import com.decentralchain.transaction.smart.script.ScriptCompiler

package object sync {
  val smartFee: Long                   = 0.004.unitoken
  val minFee: Long                     = 0.001.unitoken
  val leasingFee: Long                 = 0.001.unitoken
  val issueFee: Long                   = 1.unitoken
  val reissueFee: Long                 = 1.unitoken
  val reissueReducedFee: Long          = 0.001.unitoken
  val burnFee: Long                    = 0.001.unitoken
  val invokeFee: Long                  = 0.009.unitoken
  val sponsorFee: Long                 = 1.unitoken
  val sponsorReducedFee: Long          = 0.001.unitoken
  val setAssetScriptFee: Long          = 1.unitoken
  val setScriptFee: Long               = 0.01.unitoken
  val transferAmount: Long             = 10.unitoken
  val leasingAmount: Long              = transferAmount
  val issueAmount: Long                = transferAmount
  val massTransferFeePerTransfer: Long = 0.0005.unitoken
  val someAssetAmount: Long            = 9999999999999L
  val matcherFee: Long                 = 0.003.unitoken
  val orderFee: Long                   = matcherFee
  val smartMatcherFee: Long            = 0.007.unitoken
