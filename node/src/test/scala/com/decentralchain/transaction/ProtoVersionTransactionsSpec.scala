...
class ProtoVersionTransactionsSpec extends FreeSpec with TransactionGen with Matchers {
  ...
  "all txs" - {
    ...
    "TransferTransaction" in {
      ...
      val transferTx =
        TransferTransaction
          .selfSigned(TxVersion.V3, Account, recipient, asset, 100, Asset.unitoken, MinFee, ByteStr(attachment), Now)
          .explicitGet()
    ...
    "MassTransferTransaction" in {
      ...
      val massTransferTx =
        MassTransferTransaction
          .selfSigned(TxVersion.V2, Account, Asset.unitoken, transfers, MassTransferTxFee, Now, ByteStr(attachment))
          .explicitGet()
