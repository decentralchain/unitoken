...
import com.decentralchain.settings.{FunctionalitySettings, GenesisSettings, GenesisTransactionSettings, unitokenSettings}
...
object TestHelpers {
  ...
  def enableNG(settings: unitokenSettings): unitokenSettings =
    settings.copy(
