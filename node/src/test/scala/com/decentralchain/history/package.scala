...
package object history {
  ...
  val MicroblocksActivatedAt0unitokenSettings: unitokenSettings        = settingsWithFeatures(BlockchainFeatures.NG)
  val DataAndMicroblocksActivatedAt0unitokenSettings: unitokenSettings = settingsWithFeatures(BlockchainFeatures.DataTransaction, BlockchainFeatures.NG)
  val TransfersV2ActivatedAt0unitokenSettings: unitokenSettings        = settingsWithFeatures(BlockchainFeatures.SmartAccounts)
  ...
  val DefaultunitokenSettings: unitokenSettings = settings.copy(
