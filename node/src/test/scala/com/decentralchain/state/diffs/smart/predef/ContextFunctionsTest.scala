...
import com.decentralchain.features.BlockchainFeatures.{BlockV5, FeeSponsorship}
import com.decentralchain.lagonaki.mocks.TestBlock._
  ...
  private val preconditionsAndPayments = for {
    ...
    untypedScript <- Gen
      ...
      .map {
        ...
        case 2 => scriptWithV1unitokenFunctions(dataTransaction, transfer)
