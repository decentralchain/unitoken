...
import com.decentralchain.features.MultiPaymentPolicyProvider._
import com.decentralchain.lang.directives.DirectiveSet
import com.decentralchain.lang.v1.traits._
import com.decentralchain.lang.v1.traits.domain.Recipient._
...
object unitokenEnvironment {
  type In = Transaction :+: Order :+: PseudoTx :+: CNil
}

class unitokenEnvironment(
    nByte: Byte,
  ...
  import com.decentralchain.lang.v1.traits.Environment._
  ...
  override def accountunitokenBalanceOf(addressOrAlias: Recipient): Either[String, Environment.BalanceDetails] = {
    (for {
      ...
      address <- blockchain.resolveAlias(aoa)
      portfolio = blockchain.unitokenPortfolio(address)
