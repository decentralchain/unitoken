...
import com.decentralchain.transaction.TxValidationError.{AlreadyInTheState, GenericError, SenderIsBlacklisted}
...
import com.decentralchain.utils.{LoggerFacade, Schedulers, ScorexLogging, Time}
...
class UtxPoolImpl(
  ...
  import com.decentralchain.utx.UtxPoolImpl._
