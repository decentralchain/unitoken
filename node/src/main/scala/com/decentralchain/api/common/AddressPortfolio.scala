...
import com.decentralchain.database.{AddressId, DBResource, KeyTags, Keys, readIntSeq}
import com.decentralchain.state.Portfolio.longSemigroup
import com.decentralchain.state.{AssetDescription, Diff}
