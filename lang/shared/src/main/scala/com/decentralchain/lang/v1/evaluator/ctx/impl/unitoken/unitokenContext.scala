...
import com.decentralchain.lang.v1.evaluator.ctx.impl.unitoken.Functions.{addressFromStringF, _}
import com.decentralchain.lang.v1.evaluator.ctx.impl.unitoken.Types._
import com.decentralchain.lang.v1.evaluator.ctx.impl.unitoken.Vals._
import com.decentralchain.lang.v1.traits._

object unitokenContext {
  ...
  private def variableTypes(version: StdLibVersion, proofsEnabled: Boolean) =
    buildunitokenTypes(proofsEnabled, version)           ++
