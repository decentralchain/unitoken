...
import com.decentralchain.lang.v1.repl.node.http.NodeClient._
import com.decentralchain.lang.v1.repl.node.http.response.ImplicitMappings
import com.decentralchain.lang.v1.repl.node.http.response.model.Transaction._
import com.decentralchain.lang.v1.repl.node.http.response.model._
import com.decentralchain.lang.v1.traits.Environment.InputEntity
...
private[repl] case class WebEnvironment(settings: NodeConnectionSettings) extends Environment[Future] {
  ...
  override def accountunitokenBalanceOf(
      recipient: Recipient
