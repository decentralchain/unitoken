...
import com.decentralchain.common.state.diffs.ProduceError
...
import com.decentralchain.lang.v1.evaluator.ctx.impl.{EnvironmentFunctions, PureContext, _}
...
object Common {
  ...
  def emptyBlockchainEnvironment(h: Int = 1, in: Coeval[Environment.InputEntity] = Coeval(???), nByte: Byte = 'T'): Environment[Id] = new Environment[Id] {
    ...
    override def accountunitokenBalanceOf(addressOrAlias: Recipient): Either[String, Environment.BalanceDetails]    = ???
